...
if __name__ == "__main__":
    ...
    df = pd.read_csv(CSV_PATH + "/features_1mus_ts_df.csv")
    ...
    fig.tight_layout()
    fig.savefig(FIGURES_PATH + "/features_1mus_ts_df.pdf")
    plt.close(fig)

    plot_boxplots_from_csv_classes(
        CSV_PATH + "/features_1mus_ts_event_duration_histo.csv",
        x_col="gap_fixed",
        ...
        sort_classes=True,
        save_path=FIGURES_PATH + "/features_1mus_ts_event_duration_histo.pdf",
    )

    plot_boxplots_from_csv_classes(
        CSV_PATH + "/features_1mus_ts_event_energy_histo.csv",
        x_col="gap_fixed",
        y_col="event_energy",
        title="Spaltabstand vs Eventenergy",
        xlabel="Spaltabstand d in cm",
        ylabel="Eventenergy in J",
        sort_classes=True,
        save_path=FIGURES_PATH + "/features_1mus_ts_event_energy_histo.pdf",
    )
